...
import { createNewsCategory } from "../../services/getNewsCategory";
...
const Guests = () => {
    ...
    const handleNewsCategoryTitleChange = (e: any) => {
        setNewsCategoryTitle(e.currentTarget.value)
    }

    const handleNewsCategoryImageUrlChange = (e: any) => {
    ...
    const handleNewsCategoryClick = (e: React.MouseEvent<HTMLDivElement>) => {
            ...
            <div className="bg-gray-100 flex space-x-2 flex-row h-[90vh] px-[15px] py-[8px] text-black  w-full">
                    ...
                    <div className="mt-[10px] flex flex-col px-[10px]">
                        ...
                        <div className="overflow-y-scroll overflow-x-hidden flex flex-col space-y-[8px] h-[480px]">
                            ...
                            <div className="flex  px-[20px] pb-[10px]">
                                <div onClick={addNews} className="bg-blue-500 cursor-pointer w-fit px-[15px] py-[5px] rounded">
                                    <p>Submit</p>
                                </div>
                            </div>
                ...
                <div className=" py-[10px] px-[10px] bg-gray-200 rounded-[10px] h-[85%] w-[30%]">
                    ...
                    <div className=" flex flex-row justify-end  space-x-[5px] text-[13px] ">
                        ...
                        <div onClick={handleUpload} className="bg-blue-600 text-white flex items-center justify-center px-[15px] py-[5px] cursor-pointer rounded border-[1px] border-gray-500">
                            <p>Add Category</p>
                        </div>
                    </div>
                    <div>
